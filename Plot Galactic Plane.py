...
plt.ylabel('X-X(W75N): Distance towards Galactic Center (pc)')
plt.xlabel('Y-Y(W75N): Distance along Galactic Rotation (pc)')
...
Z_gal = objects_data['Z_gc_kpc'].values * 1000  # Convert kpc to pc
