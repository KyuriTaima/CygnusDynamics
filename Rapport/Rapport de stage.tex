...
\begin{document}
	...
	\begin{figure}[H]
		...
		\caption{Traceback linéaire sur le plan galactique des objets du Cygne à  $0$, $-4.5$ et $-9.8 \ \mathrm{Myr}$. L'origine est la position actuelle du nuage W75N. L'axe des abscisses est $Y-Y(W75N)$. L'axe des ordonnées est $X-X(W75N)$.}
