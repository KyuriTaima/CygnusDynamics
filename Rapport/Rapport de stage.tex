...
\begin{document}
	...
	\begin{align*}
		dx &= x_{\text{gal}} - x_{\text{W75N}} ; \qquad dy = y_{\text{gal}} - y_{\text{W75N}} ; \qquad dz = z_{\text{gal}} - z_{\text{W75N}} \\[0.3cm]
		\beta &= \arctan\left(\frac{y_{\text{W75N}}}{x_{\text{W75N}}}\right) \\[0.5cm]
		x_{\text{cyg}} &= -dx \cdot \sin(\beta) + dy \cdot \cos(\beta) \\
		y_{\text{cyg}} &= -(dx \cdot \cos(\beta)) + dy \cdot \sin(\beta) \\
		z_{\text{cyg}} &= dz
	\end{align*}
	\begin{figure}[H]
		\centering
