...
\begin{document}
	...
	\end{align*}
	Les résultats concordent dans la limite des incertitudes utilisées, on peut donc en conclure que la méthode de calcul des vitesses est cohérente avec l’article de Rygl et al. \cite{rygl2012}.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=7cm]{mu_l as a fct of l.png}
	...
	Afin de modéliser les positions et les vitesses des objets en 3D, je prends pour origine du repère le nuage W75N. 
	\begin{figure}[H]
		\centering
		\begin{minipage}{0.45\textwidth}
			\centering
