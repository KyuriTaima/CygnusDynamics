...
\begin{document}
	...
	Afin d'apprécier les distances des objets au soleil, je projette les vitesses $U_pec$ et $V_pec$ des objets sur le plan galactique en figure \ref{fig:bobylev_U_V_plane}. La vitesse $U_pec$ est positive selon l'axe des ordonnées et la vitesse $V_pec$ est positive selon l'axe des abscisses. Le vecteur résultant est la somme de ces deux vitesses.  
	\begin{figure}[H]
		\centering
	...
	Ces projections en 2D ne permettent pas de visualiser la cinématique globale des la région du Cygne, pour cela, il est nécessaire de faire une modélisation en 3D.
