...
\begin{document}
	...
	Avec cette modélisation plus réaliste, nous obtenons un TCA de $-2.9^{+1.9}_{-2.7} \ \mathrm{Myr}$ pour le super-amas BCE et un TCA de $-6.9^{+3.0}_{-5.4} \ \mathrm{Myr}$. Les graphiques sont disponibles en annexe \ref{appendix:complementary_graphs}, figures METTRE REF Ces résultats évoquent des évènements de formation plus récents mais les valeurs obtenues précédemment sont tout de même contenues dans les barres d'erreurs.
