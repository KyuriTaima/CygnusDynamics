...
\begin{document}
	...
	On souhaite accréter autant de particules que le nombre de particules initiales: $\pi R_{fil}^2 \times L_{fil} \times n_{fil} = 2R_B \times L_{fil} \times l \times n_{halo}$.
