...
\begin{document}
	...
	Mes remerciements s’adressent également à Mmes Marie-Hélène Grondin et Yasmine Bercy ainsi qu'à monsieur Jean-Christophe Delagnes pour leur soutien, tant lors de la recherche de stage qu’au cours de son déroulement.
	...
	Enfin je souhaite remercier mes co-stagiaires Elise Peris, Quentin Sabucco et Corentin Canu avec qui j'ai pu échanger tout au long du stage et qui ont sur rendre toute cette aventure plus palpitante, notamment grâce à la quête des gâteaux du Crous de 11h30 ou encore la recherche des potins les plus croustillants.
	...
	\begin{figure}[H]
		...
		\caption{Traceback linéaire sur le plan galactique des objets du Cygne à  $0$, $-4.5$ et $-9.8 \ \mathrm{Myr}$. L'origine est le centre galactique, l'objet de référence est la position du nuage W75N actuellement. L'axe des abscisses est $Y$. L'axe des ordonnées est $X-X(W75N)$. Les nuages sont en bleu, les groupes d'étoiles OB en rouge et vert.}
