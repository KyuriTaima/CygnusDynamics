...
\begin{document}
	...
	Avec une vitesse de $15 \ \mathrm{pc} \cdot \mathrm{Myr^{-1}}$, le nuage prendrais approximativement 4 millions d'années avant d'accréter assez de matière pour doubler sa densité initiale et commencer à former des étoiles massives. Ce résultat est cohérent avec les TCA calculé précédemment car cela signifierait que les nuages commencent à former des étoiles avant d'être au plus proche puis continuent à former des étoiles massives en s'éloignant les uns des autres.
