...
\begin{document}
	...
	L'ensemble des résultats cinématiques appliqués aux nuages moléculaires et aux groupes d'étoiles OB de Cygnus X est compilé dans le Tableau \ref{tab:donnees_cinematiques}. Les distances d'entrée proviennent des travaux de Rygl et al. \cite{rygl2012} pour les nuages et de Quintana et al. \cite{quintana2021} pour les amas. Les données brutes utilisées pour ces calculs sont répertoriées dans le Tableau 1 en Annexe \ref{annexe:donnees_entree}, tandis que les résultats des calculs intermédiaires figurent dans le Tableau A.2 en Annexe \ref{annexe:calculs_intermediaires}.
