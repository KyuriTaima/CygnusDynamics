...
\begin{document}
	...
	Pour le super-amas BEC, j'obtiens un TCA de $-4.5 \ Myr$ avec une distance relative minimale de $95.6 \ \mathrm{pc}$. Pour le groupe FAD, j'obtiens un TCA de $-9.8 \ Myr$ avec une distance relative minimale de $62.2 \ \mathrm{pc}$. Ces valeurs concordent parfaitement avec celles de Quintana et al. \cite{quintana2022}, qui datent les associations B, C et E de 3 à 5 millions d'années et les associations F, A et D d'environ 10 millions d'années.
