...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{l c c}
			...
			\hline
		\end{tabular}
		\caption{Comparaison des paramètres du LSR et des composantes du mouvement solaire particulier entre le modèle historique et le modèle révisé utilisé dans cette étude.}
