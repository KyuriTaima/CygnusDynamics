...
\begin{document}
	...
	Afin de modéliser les positions et les vitesses des objets en 3D, j'utilise le même repère que pour la représentation en 2D. La modélisation en 3D est difficilement appréciable sur un support 2D, le fichier est disponible à l'adresse \href{https://github.com/KyuriTaima/CygnusDynamics/blob/8276b42224d7c76e1cba126970f6e30ef20acc10/Carte_Cygnus_3D_quiver.html }{Lien vers fichier 3D}. Quelques vues 3D sont aussi disponibles en annexe \ref{appendix:complementary_graphs}, figures \ref{fig:3D_view_1} et \ref{fig:3D_view_2}.
