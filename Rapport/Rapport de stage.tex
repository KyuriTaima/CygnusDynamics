...
\begin{document}
	...
	\begin{abstract}
		...
		Les groupes d'étoiles massives de type OB sont rares et jouent un rôle important dans la compréhension de l'évolution de notre galaxie. Leur origine et leur cinématique est toujours à l'étude, et nécessite des mesures précises, acquises avec de récentes missions. Cette cinématique n'a pas encore été mise en relation avec les nuages de gaz moléculaires existants que l'on soupçonne de former actuellement des groupes d'étoiles OB. Je m'intéresse à la région du Cygne, située dans notre galaxie à $1,5 \ \mathrm{kpc}$. L'objectif de ce travail est d'établir une vue d'ensemble des nuages moléculaires et des groupes d'étoiles OB afin de visualiser leur positions et leur vitesses en 3D. J'effectue ensuite un \textit{traceback} des positions des différents objets à des dates clés afin d'obtenir les positions théoriques des amas, et leurs distances relatives, lors de leur formation. Les résultats permettent d'identifier deux super-amas contenant 3 amas chacun, avec leur positions et leur vitesses en 3D. Leur temps de formation cinématique est estimé à $4 \ \mathrm{Myr}$ et $8 \ \mathrm{Myr}$. Cela nous permet de proposer un scénario complet où un nuage suit la rotation de la galaxie (W75N, Groupe E, Groupe D), alors que les autres nuages ont une vitesse tangentielle inférieure à la vitesse de rotation de la galaxie et rentrent donc en collision avec ces derniers, permettant d'augmenter la densité des nuages et de former de nombreuses étoiles massives. Enfin, en superposant les trajectoires des objets avec la position des bras galactique, on constate que la formation d'étoiles massives a lieu sur les bords du bras Local, et que les bras galactiques jouent un rôle dans la dynamique des nuages moléculaires engendrant des collisions, et ultimement la formation de groupes d'étoiles massives.
