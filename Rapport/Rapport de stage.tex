...
\begin{document}
	...
	\begin{figure}[H]
		...
		\label{fig:3D_view}
	\end{figure}
	La modélisation 3D permet de se rendre compte des vitesses différentielles entre les objets. Au niveau du complexe de nuages moléculaires, W75N est presque immobile par rapport à la rotation de la Galaxie alors que les autres nuages sont ralentis de 14 à 15 km/s par rapport à la rotation moyenne de la galaxie, de plus, ils montent vers le pôle nord galactique. Au niveau du super-groupe BEC, le groupe B est plus haut que les deux autres groupes, mais les vitesses des groupes B et C sont similaires tandis que le groupe E a une vitesse beaucoup plus faible et dans une direction différente.
	...
	L'objectif de cet exercice, est de déterminer la temporalité des différents évènements de formation des groupes d'étoiles massives. On pourra ainsi essayer de reconnaitre un motif qui se répète au fur et à mesure des différents évènements de formations.
