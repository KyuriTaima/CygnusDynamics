...
\begin{document}
	...
	Afin d'apprécier les distances des objets au soleil, je projette les vitesses $U_{pec}$ et $V_{pec}$ des objets sur le plan galactique en figure \ref{fig:bobylev_U_V_plane}. La vitesse $U_{pec}$ est positive selon l'axe des ordonnées et la vitesse $V_pec$ est positive selon l'axe des abscisses. Le vecteur résultant est la somme de ces deux vitesses.  
	\begin{figure}[H]
		\centering
