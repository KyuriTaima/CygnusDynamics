...
\begin{document}
	...
	Le référentiel galactocentrique cartésien a pour origine le centre galactique, l'axe des abscisses ($\vec{x}$) est la droite formée par le Soleil et le centre galactique, avec pour convention une valeur positive lorsque l'on se rapproche du centre galactique. L'axe des ordonnées est la droite orthogonale à l'axe des abscisses dans le plan galactique, les valeurs sont positives dans le sens de la rotation galactique. L'axe $z$ pointe vers le pôle nord galactique, il est donc orthogonal au plan galactique.
