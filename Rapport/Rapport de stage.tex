...
\begin{document}
	...
	\begin{abstract}
		...
		Massive OB-type star clusters are rare and play an important role in understanding the evolution of our galaxy. Their origin and kinematics are still being studied and require precise measurements, which have been obtained through recent missions. This kinematics has not yet been linked to existing molecular gas clouds that are suspected of currently forming OB star clusters. This study is set in the Cygnus region, located $\approx 1.5 \ \mathrm{kpc}$ from our galaxy. The objective of this work is to establish an overview of the molecular clouds and OB star clusters in order to visualize their positions and velocities in 3D. I then perform a \textit{traceback} of the positions of the various objects at key dates to obtain the theoretical positions of the clusters, as well as their relative distances, at the time of their formation. The results allow us to identify two superclusters, each containing three clusters, along with their 3D positions and velocities. Their kinematic formation times are estimated at $4 \ \mathrm{Myr}$ and $8 \ \mathrm{Myr}$. This allows us to propose a comprehensive scenario in which one cloud follows the galaxy’s rotation (W75N, Group E, Group D), while the other clouds have a tangential velocity lower than the galaxy’s rotational velocity and therefore collide with the former, thereby increasing the density of the clouds and leading to the formation of numerous massive stars.
