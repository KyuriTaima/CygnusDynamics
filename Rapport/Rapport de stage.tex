...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=3.5cm,keepaspectratio]{Kinematics_XZ_plane.png}
	...
	Code Python: Visual Studio / Github Copilot
	...
	\begin{abstract}
		...
		Les groupes d'étoiles massives de type OB sont rares et jouent un rôle important dans la compréhension de l'évolution de notre galaxie. Leur origine et leur cinématique est toujours à l'étude, et nécessite des mesures précises, acquises avec de récentes missions. Cette cinématique n'a pas encore été mise en relation avec les nuages de gaz moléculaires existants que l'on soupçonne de former actuellement des groupes d'étoiles OB. Je m'intéresse à la région du Cygne, située dans notre galaxie à $\approx1,5 \ \mathrm{kpc}$. L'objectif de ce travail est d'établir une vue d'ensemble des nuages moléculaires et des groupes d'étoiles OB afin de visualiser leur positions et leur vitesses en 3D. J'effectue ensuite un \textit{traceback} des positions des différents objets à des dates clés afin d'obtenir les positions théoriques des amas, et leurs distances relatives, lors de leur formation. Les résultats permettent d'identifier deux super-amas contenant 3 amas chacun, avec leur positions et leur vitesses en 3D. Leur temps de formation cinématique est estimé à $\approx4 \ \mathrm{Myr}$ et $\approx8 \ \mathrm{Myr}$. Cela nous permet de proposer un scénario complet où un nuage suit la rotation de la galaxie (W75N, Groupe E, Groupe D), alors que les autres nuages ont une vitesse tangentielle inférieure à la vitesse de rotation de la galaxie et rentrent donc en collision avec ces derniers, permettant d'augmenter la densité des nuages et de former de nombreuses étoiles massives. Enfin, en superposant les trajectoires des objets avec la position des bras galactique, on constate que la formation d'étoiles massives a lieu sur les bords du bras Local, et que les bras galactiques jouent un rôle dans la dynamique des nuages moléculaires engendrant des collisions, et ultimement la formation de groupes d'étoiles massives.
		
		\textbf{Mots clés:} Formation d'étoiles - Cygnus X - Cyg OB2 - Potentiel gravitationnel - Cinématique et dynamique - Etoiles de type O et B - Bras galactique
		
		\vspace{1.5cm}
		
		\textbf{English} \\
		
		Massive OB-type star clusters are rare and play an important role in understanding the evolution of our galaxy. Their origin and kinematics are still being studied and require precise measurements, which have been obtained through recent missions. This kinematics has not yet been linked to existing molecular gas clouds that are suspected of currently forming OB star clusters. This study is set in the Cygnus region, located $\approx 1.5 \ \mathrm{kpc}$ from our galaxy. The objective of this work is to establish an overview of the molecular clouds and OB star clusters in order to visualize their positions and velocities in 3D. I then perform a \textit{traceback} of the positions of the various objects at key dates to obtain the theoretical positions of the clusters, as well as their relative distances, at the time of their formation. The results allow us to identify two superclusters, each containing three clusters, along with their 3D positions and velocities. Their kinematic formation times are estimated at $\approx4 \ \mathrm{Myr}$ and $\approx8 \ \mathrm{Myr}$. This allows us to propose a comprehensive scenario in which one cloud follows the galaxy’s rotation (W75N, Group E, Group D), while the other clouds have a tangential velocity lower than the galaxy’s rotational velocity and therefore collide with the former, thereby increasing the density of the clouds and leading to the formation of numerous massive stars.
		
		\textbf{Keywords:} Star Formation - Cygnus X - Cyg OB2 - Gravitational Potential - Kinematics and Dynamics - O- and B-type Stars - Galactic Arm		
