...
\begin{document}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[height=4cm]{Cygnus_geometry_plane.png}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\includegraphics[height=4cm]{Cygnus_geometry_Z.png}
	...
	Enfin, pour corriger la perspective orbitale induite par l'angle $\beta$, j'applique une rotation matricielle des axes (Figure \ref{fig:geometry_lsr_to_peculiar}). Je soustrais également la vitesse circulaire locale $\Theta_0$ pour isoler la composante de vitesse galactocentrique particulière, notée $V_{pec}$ :
	\begin{align}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height=5cm]{Transform_Vlsr_Vpec.png}
	...
	Afin de permettre des comparaisons directes avec d'autres publications ou de réaliser des projections cartographiques bidimensionnelles, je projette également ces vecteurs sur les axes galactiques apparents pour obtenir les vitesses propres longitudinale ($v_l$) et latitudinale ($v_b$) :
	\begin{align}
	...
	L'ensemble des résultats cinématiques appliqués aux nuages moléculaires et aux groupes d'étoiles OB de Cygnus X est compilé dans le Tableau \ref{tab:donnees_cinematiques}. Les distances d'entrée proviennent des travaux de Rygl et al. \cite{rygl2012} pour les nuages et de Quintana et al. \cite{quintana2021} pour les amas. Les données brutes utilisées pour ces calculs sont répertoriées dans le Tableau 1.A en Annexe \ref{annexe:donnees_entree}, tandis que les résultats des calculs intermédiaires figurent dans le Tableau 2.A en Annexe \ref{annexe:calculs_intermediaires}. 
	...
	\begin{table}[H]
		...
		\caption{Paramètres cinématiques corrigés et distances héliocentriques des structures de Cygnus X.}
