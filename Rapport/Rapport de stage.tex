...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{l c c}
			\hline
			\textbf{Paramètre galactique} & \textbf{Valeurs historiques} & \textbf{Valeurs révisées} \\
			...
			\hline
		\end{tabular}
		\caption{Comparaison des paramètres du LSR et des composantes du mouvement solaire particulier entre le modèle de Schönrich et al. et le modèle de Bobylev et al. utilisé dans cette étude.}
	...
	\end{itemize}
	Ces constantes mis à jour serviront de base à l'unification des différents jeux de données dans le référentiel galactocentrique commun.
