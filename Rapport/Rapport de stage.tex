...
\begin{document}
	...
	\label{annexe:donnees_complémentaires}
		\begin{table}[H]
			...
			\caption{Données astrométriques brutes telles que publiées dans la littérature. Ce tableau met en évidence l'hétérogénéité des référentiels d'origine : mouvements propres équatoriaux pour les nuages (Rygl et al. 2012) et galactiques pour les amas stellaires (Quintana et al. 2021).}
