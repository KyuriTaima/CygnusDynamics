...
\begin{document}
	...
	\begin{abstract}
		\begin{center}
			...
			\vspace{0.2cm}
			\textit{de la Croix, Sulwen} \\
			\textit{Master 1 de physique fondamentale et applications, Parcours NPU (UB / Laboratoire d'Astrophysique de Bordeaux)} \\
			\vspace{0.5cm}
		\end{center}
		
		\noindent Directeur de stage : Sylvain Bontemps \dots
