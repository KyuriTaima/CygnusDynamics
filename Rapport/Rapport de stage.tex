...
\begin{document}
	...
	$$d \ = \ \sqrt{(x(t)_1 \ - \ x(t)_2)^2 \ + \ (y(t)_1 \ - \ y(t)_2)^2 \ + \ (z(t)_1 \ - \ z(t)_2)^2}$$
	
	Puis je prend la moyenne des trois distances à l'instant $t$, la valeur minimale est le "Time of Closest Approach".
