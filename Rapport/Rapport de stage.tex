...
\begin{document}
	...
	Les traceback linéaires des super-groupes BEC et FAD sur le plan galactique sont tracés en annexe \ref{appendix:complementary_graphs} en figure \ref{fig:linear_traceback_XY_global} Le calcul effectué pour tracer la position à chaque instant $t$ est détaillé en annexe \ref{appendix:linear_traceback}.
	...
	\begin{figure}[H]
		\includegraphics[height=6.5cm]{linear_traceback_BEC_XY.png}
		\includegraphics[height=7cm]{linear_traceback_FAD_XY.png}
		\caption{Traceback linéaire des amas d'étoiles selon le plan galactique. \textbf{À gauche :} les amas B, E et C. \textbf{À droite :} les amas F, A et D. L'axe des abscisses représente la distance au centre galactique, et l'axe des ordonnées représente la tangente à la trajectoire de rotation moyenne de la galaxie au niveau du Cygne.}
