		...
		\begin{table}[H]
			...
			\resizebox*{\textwidth}{!}{
				\begin{tabular}{l c c c c c c c c c c c c}
					\hline
					\textbf{Objet} & \textbf{RA} & \textbf{Dec} & $\mathbf{l}$ & $\mathbf{b}$ & \textbf{Distance} & $\mathbf{\mu_\alpha \cos \delta}$ & $\mathbf{\mu_\delta}$ & $\mathbf{\mu_l \cos b}$ & $\mathbf{\mu_b}$ & $\mathbf{V_{rad}}$ & $\mathbf{V_{LSR}}$ \\
			...
			\caption{Données astrométriques brutes telles que publiées dans la littérature. Ce tableau met en évidence l'hétérogénéité des référentiels d'origine : mouvements propres équatoriaux pour les nuages (Rygl et al. 2012) et galactiques pour les amas stellaires (Quintana et al. 2021). Les données d'âge d'expansion ont été omises ici par souci de clarté.}
