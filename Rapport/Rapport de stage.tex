...
\begin{document}
	...
	\end{figure}
	Sur la figure \ref{fig:traceback_mosaique}, on peut voir que le groupes E s'éloigne des groupes B et C à partir de 4.5 Myr et que les groupes B et C sont très proches à 8.5 Myr puis s'éloignent si on remonte plus loin dans le temps. Les groupes F,A et D se rapprochent jusqu'à 10 Myr puis s'éloignent les uns des autres, jusqu'à ce que le groupe A se rapproche du groupe B vers 15 Myr. Les nuages moléculaires s'éloignent les uns des autres si on remonte dans le passé, ils sont donc actuellement plus proche les uns des autres qu'ils ne l'ont jamais été par le passé.
	...
	Alors que le super-groupe FAD est toujours relativement compact, même il y a environ 20 millions d'années, les amas du super-groupe BEC semblent s'être éloignés les uns des autres depuis leur formation.
