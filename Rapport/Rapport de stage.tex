...
\begin{document}
	...
	Pour les transformations linéaires, je calcule les incertitudes via la formule de propagation des erreurs au premier ordre (Taylor \cite{taylor1997}). Pour les fonctions non linéaires, j'effectue un échantillonnage par méthode de Monte-Carlo comprenant $10\,000$ tirages. Les calculs d'incertitudes détaillés est documentée en Annexe \ref{annexe:methode_incertitudes}.
