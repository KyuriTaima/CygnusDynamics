...
\begin{document}
	...
	Je souhaite remercier toute l'équipe FEMIS et plus particulièrement Timea Csengeri pour leur accueil chaleureux et plein d'enthousiasme au sein du LAB.
	...
	Je suis reconnaissant envers MM. Yassin Khalil (Dipartimento di Fisica e Astronomia, Università degli Studi di Firenze) et Benoit Famaey (Université de Strasbourg) pour leur collaboration enrichissante et bienveillante, qui a grandement contribué à approfondir cette analyse cinématique.
	
	Enfin je souhaite remercier mes co-stagiaires Elise Peris, Quentin Sabuco, Corentin Canu et Laura Charbonnier, pour les pauses précieuses qui ont permis de s'aérer l'esprit.
	\newpage
	...
	La visualisation 3D permet de se rendre compte des vitesses différentielles entre les objets. Au niveau du complexe de nuages moléculaires, W75N est presque immobile par rapport à la rotation de la Galaxie alors que les autres nuages sont ralentis de $14$ à $15 \ \mathrm{km\cdot s^{-1}}$ par rapport à la rotation moyenne de la galaxie, de plus, ils montent vers le pôle nord galactique. Au niveau du super-amas E-BC, le groupe B est plus haut que les deux autres amas, mais les vitesses des groupes B et C sont similaires tandis que le groupe E a une vitesse beaucoup plus faible, et dans une direction différente. Il est proche de la rotation galactique comme le nuage W75N.
	...
	Pour le super-amas E-BC, j'obtiens un TCA de $-3.3 \pm 1.8 \ \mathrm{Myr}$ avec une distance relative minimale de $100 \pm 12.3 \ \mathrm{pc}$. Pour le groupe D-FA, j'obtiens un TCA de $-6.6 \pm \ 3.3 \ \mathrm{Myr}$ avec une distance relative minimale de $73 \pm 20.1 \ \mathrm{pc}$. Ces valeurs concordent parfaitement avec celles de Quintana et al. \cite{quintana2022}, qui datent les associations B, C et E de 3 à 5 millions d'années et les associations F, A et D d'environ 10 millions d'années.
	...
	\begin{figure}[H]
		...
		\caption{Traceback linéaire des amas d'étoiles du super-groupe E-BC selon le plan galactique. L'axe des abscisses représente la distance au centre galactique, et l'axe des ordonnées représente la tangente à la trajectoire de rotation moyenne de la galaxie au niveau du Cygne.}
	...
	\begin{figure}[H]
		...
		\caption{Traceback linéaire des amas d'étoiles du super-groupe D-FA selon le plan galactique. L'axe des abscisses représente la distance au centre galactique, et l'axe des ordonnées représente la tangente à la trajectoire de rotation moyenne de la galaxie au niveau du Cygne.}
