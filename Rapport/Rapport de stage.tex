...
\begin{document}
	...
	Pour le super-amas BEC, j'obtiens un TCA de $-3.3 \ \pm 1.8 \ \mathrm{Myr}$ avec une distance relative minimale de $99.5 \ \pm 12.3 \☻ \mathrm{pc}$. Pour le groupe FAD, j'obtiens un TCA de $-6.6 \ \pm \ 3.3 \ \mathrm{Myr}$ avec une distance relative minimale de $72.8 \ \pm 20.1 \ \mathrm{pc}$. Ces valeurs concordent parfaitement avec celles de Quintana et al. \cite{quintana2022}, qui datent les associations B, C et E de 3 à 5 millions d'années et les associations F, A et D d'environ 10 millions d'années.
