...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth, height=8cm, keepaspectratio]{traceback_3D_4,5.png}
		
		\vspace{0.4cm}
		
		\includegraphics[width=0.8\textwidth, height=8cm, keepaspectratio]{traceback_3D_9,8.png} 
