...
\begin{document}
	...
	\begin{figure}[H]
		...
		\caption{Traceback linéaire sur le plan galactique des objets du Cygne à  $0$, $-4.5$ et $-9.8 \ \mathrm{Myr}$. L'origine est le centre galactique. L'axe des abscisses est $Y$. L'axe des ordonnées est $X-X(W75N)$. Les nuages sont en bleu, les groupes d'étoiles OB en rouge et vert.}
