...
\begin{document}
	...
	On souhaite accréter autant de particules que le nombre de particules initiales: $$\pi R_{fil}^2 \times L_{fil} \times n_{fil} = 2R_B \times L_{fil} \times l \times n_{halo} \Leftrightarrow l \ = \ \frac{\pi}{2} \frac{R_{fil}^2}{R_B} \times \frac{n_{fil}}{n_{halo}} \ = \textbf{14.1 \ \mathrm{pc}} $$.
