...
\begin{document}
	...
	\label{annexe:donnees_complémentaires}
		...
		\begin{table}[H]
			...
			\caption{Propriétés physiques et cinématiques internes des amas stellaires. L'ensemble de ces données proviennent de Quintana et al. 2021. Ces données ne sont pas disponibles pour les nuages moléculaires}
