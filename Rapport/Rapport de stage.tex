...
\begin{document}
	...
	La projection de la vitesse du soleil dans le standard LSR dépend des incertitudes sur les longitudes et latitudes galactiques qui sont négligeables par rapport aux incertitudes sur la vitesse LSR des objets observés, donc: $\Delta V_{RV} \ = \ \Delta v_{lsr}$
