...
# Use diffente colors, green for groups B,E and C; red for groups A,D and F; blue for the rest
plt.scatter(l_deg, b_deg, color='black', marker='o', s=10, label='Objects')
